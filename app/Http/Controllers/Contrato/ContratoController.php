        ...
        if (Session::has('AUTENTICADO')) {
            if ($request->ajax()) {
                try {
                    ...
                    if (session::get('ID_SUCURSAL') == 19) {
                        if (Session::get('NROCAJA') == 1) {
                            $codigo_contrato = '4NV1';
                        } else {
                            $codigo_contrato = '4NV2';
                        }
                    }

                    if (session::get('ID_SUCURSAL') == 20) {
                        if (Session::get('NROCAJA') == 1) {
                            $codigo_contrato = 'OB1';
                        } else {
                            $codigo_contrato = 'OB2';
                    ...
                    if (session::get('ID_SUCURSAL') == 25) {
                        if (Session::get('NROCAJA') == 1) {
                            $codigo_contrato = 'CBA1';
                        } else {
                            $codigo_contrato = 'CBA2';
                        }
                    }

                    if (session::get('ID_SUCURSAL') == 26) {
                        if (Session::get('NROCAJA') == 1) {
                            $codigo_contrato = 'CBH1';
                        } else {
                            $codigo_contrato = 'CBH2';
                        }
                    }

                    if (session::get('ID_SUCURSAL') == 27) {
                        if (Session::get('NROCAJA') == 1) {
                            $codigo_contrato = 'CBQ1';
                        } else {
                            $codigo_contrato = 'CBQ2';
                        }
                    }

                    if (session::get('ID_SUCURSAL') == 28) {
                        if (Session::get('NROCAJA') == 1) {
                            $codigo_contrato = 'TS1';
                        } else {
                            $codigo_contrato = 'TS2';
