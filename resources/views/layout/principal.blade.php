          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              ...
              @if (Session::get('SEXO') == 6)       
                  <img src="{{ asset('template/dist/img/avatar3.png') }}" class="user-image" alt="User Image">
              @endif

              @if (Session::get('SEXO') == '')      
                  <img src="{{ asset('template/dist/img/photo4.jpg') }}" class="user-image" alt="User Image">
              @endif              
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-header">
                ...
                @endif
                @if (Session::get('SEXO') == 6)       
                    <img src="{{ asset('template/dist/img/avatar3.png') }}" class="img-circle" alt="User Image">
                @endif
              ...
              <li class="user-footer">
                ...
                <div class="pull-right">
                  <a href="{{route('salirSesion')}}" class="btn btn-default btn-flat">Cerrar Sesión</a>
                </div>
              </li>
            </ul>
          </li>                   
    ...
    <section class="sidebar">
      ...
      <div class="user-panel">
        ...
        <div class="pull-left info">
          ...
          <a href="#"><i class="fa fa-circle text-success"></i> En Línea:   {{ Session::get('CAJA') }}</a>
        </div>
      </div>      
      ...
      @if(Session::get('ID_ROL') == 1 || Session::get('ID_ROL') == 3)
        <ul class="sidebar-menu" data-widget="tree">
          ...
          <li><a href="{{ url('Inicio') }}"><i class="fa fa-circle-o text-aqua"></i> <span>INICIO</span></a></li>
                          ...
                          <ul class="treeview-menu">
                              @if($menuMaster->subMenus($mm->id))
                                  @foreach ($menuMaster->subMenus($mm->id) as $sm)
                                      <li><a href="{{ url($sm->url) }}"><i class="fa fa-circle-o"></i> {{ $sm->opcion  }}</a></li>
...
{{-- JAVA SCRIPR SOLO NUMEROS --}}
  ...
  <script type="text/javascript" src="{{ asset('template/bower_components/sweetalert2/dist/sweetalert2.min.js') }}"></script>
  <!-- Select2 -->
