...
@section('main-content')
	...
	<form id="frmReInicioFinCaja">
		...
		<div class="row">
	        <div class="col-md-12">            
                <section class="clsRepInicioFinCaja">                	
                	@include('repInicioFinCaja.modals.listadoRepInicioFinCaja')
                </section>	            
	        </div>
	    </div>	    
	...
	<script type="text/javascript">    
		$(document).ready(function() {
	        ...
	        $('#frmReInicioFinCaja').bootstrapValidator({
	    ...
	    function fnImprimirInicioFinCaja(){
	    	...
	    	var src = "/ImprimirReInicioFinCaja/"+txtFechaInicio+"/"+ddlSucursal+"/"+ddlCaja;	 
