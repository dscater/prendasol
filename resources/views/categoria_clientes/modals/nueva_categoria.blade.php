<div id="modalCreateCategoria" class="modal fade" data-backdrop="static">
					...
					<div class="row">
                        ...
                        <div class="col-sm-6">
							<div class="form-group">
								...
								<input type="text" id="numero_contratos" name="numero_contratos" class="form-control">
							</div>							
						</div>
					</div>	
					<div class="row">
						<div class="col-sm-6">
							<div class="form-group">
								...
								<input type="text" id="porcentaje" min="1" max="100" name="porcentaje" class="form-control">
							</div>							
						</div>
					</div>
