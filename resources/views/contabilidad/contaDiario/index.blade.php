...
@include('contabilidad.contaDiario.modals.modalUpdate')
@section('main-content')
	...
	<form id="frmContaDiario">
		...
		<div class="row">
	        <div class="col-md-12">            
                <section class="clsContaDiario">                	
                	@include('contabilidad.contaDiario.modals.listadoContaDiario')
                </section>	            
	        </div>
	    </div>	    
	...
	<script type="text/javascript">    
	    ...
	    function fnEditarContaDiario(dato) {
	    	console.log("datos",dato);
	    	$("#txtCI").val(dato.contrato1.cliente.persona.nrodocumento);
	    	$("#txtNombreCompleto").val(dato.contrato1.cliente.persona.nombres +' '+ dato.contrato1.cliente.persona.primerapellido +' '+ dato.contrato1.cliente.persona.segundoapellido);
	    	if (dato.contrato1.codigo) {
	    		$("#txtContrato").val(dato.contrato1.codigo);
	    	}else{
	    		$("#txtContrato").val(dato.contrato1.codigo_num);
	    	}

	    	$("#txtSucursal").val(dato.sucural.nombre);
	    	$("#txtFecha").val(dato.fecha_a);
	    	$("#txtGlosa").val(dato.glosa);
	    	$("#txtDebe").val(dato.debe);
	    	$("#txtHaber").val(dato.haber);
	    	$("#id").val(dato.id);
	    }
	    ...
	    $("#btnActualizar").click(function(){
            ...
            $.ajax({
                ...
                success: function(data){	                    
                	...
                	if (resultado == 1) {
                    	$("#modalUpdateContaDiario").modal('toggle');
                        Swal.fire({
				            title: "CONTA DIARIO!",
				        ...
				        fnListadoContaDiario('/BuscarContaDiario');
                    }                	
	    ...
	    /******************************** LISTADO DE PERSONAS *****************************************/
	    function fnListadoContaDiario(url) {
	    	var parametros = {
	    		'txtFechaInicio':$("#txtFechaInicio").val(),
	        	'txtFechaFin':$("#txtFechaFin").val()
	    	};
	    ...
	    function fnExportarExcelContaDiario(){
	    	var fechaInicio = $("#txtFechaInicio").val();
	    	var fechaFin = $("#txtFechaFin").val();
        	$.ajax({
				type: 'GET',
				url: "ExportarContaDiario/"+fechaInicio+"/"+fechaFin,
				//data:parametros,
				// async: false,
				...
				success: function (data) {
			        ...
			        link.download = "ContaDiario"+fechaInicio+"_"+fechaFin+".xlsx";
